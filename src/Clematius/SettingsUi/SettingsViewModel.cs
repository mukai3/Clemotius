...
/// <see cref="ClematiusConfig"/> を通知する（即時適用方式）。
///
...
internal sealed partial class SettingsViewModel : ObservableObject
{
    ...
    public SettingsViewModel(ClematiusConfig config)
    {
        _original = config;
